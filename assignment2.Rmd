...
Using the **R** code provided, we obtained $\hat{p}=0.480,\quad\hat{\mu}=2.01\quad\hat{\sigma}^2=0.929\quad\hat{\lambda}=1.03$. The plot of the observed counts against the expected counts under this mixture model is shown above.